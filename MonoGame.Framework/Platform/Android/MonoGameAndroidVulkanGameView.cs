...
{
    internal sealed class MonoGameAndroidVulkanGameView : MonoGameAndroidGameView
    {
        private IntPtr _nativeWindow;

        internal override IntPtr NativeWindowHandle => _nativeWindow;

        internal MonoGameAndroidVulkanGameView(Context context, AndroidGameWindow gameWindow, Game game)
        ...
        protected override void DestroyGLContext()
        {
        ...
        protected override void CreateGLSurface()
        {
            ...
            if (_nativeWindow == IntPtr.Zero)
                throw new InvalidOperationException("ANativeWindow_fromSurface failed for the Android Vulkan surface.");
