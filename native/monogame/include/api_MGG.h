...
MG_EXPORT MGG_GraphicsDevice* MGG_GraphicsDevice_CreateWithSurface(MGG_GraphicsSystem* system, MGG_GraphicsAdapter* adapter, MGG_PresentationSurface& surface);
...
MG_EXPORT mgbyte MGG_GraphicsDevice_TryDequeueCompletedGpuFrameTiming(MGG_GraphicsDevice* device, MGG_GpuFrameTiming& timing);
