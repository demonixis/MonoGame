...
public sealed class PackNativeRuntimeTask : AsyncFrostingTask<BuildContext>
{
    ...
    public override async Task RunAsync(BuildContext context)
    {
        if (context.BuildSystem().IsRunningOnGitHubActions)
        {
            ...
            // Windows OpenGL (desktopgl) - both architectures built on the same runner
            ...
            // Linux OpenGL - x64 and arm64 from separate runners
            ...
            // macOS OpenGL - universal binary (x64 + arm64 in one file)
        ...
        context.DotNetPack("src/NuGetPackages/MonoGame.Framework.Native.OpenGL/MonoGame.Framework.Native.OpenGL.csproj", context.DotNetPackSettings);
