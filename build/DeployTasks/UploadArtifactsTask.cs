        ...
        switch (context.Environment.Platform.Family)
        {
            case PlatformFamily.Windows:
                ...
                foreach (var winArch in new[] { "x64", "arm64" })
                {
                    ...
                    await context.GitHubActions().Commands.UploadArtifact(new DirectoryPath($"Artifacts/native/mgfx-spvc/windows/{winArch}/Release/"), $"mgfx-spvc-windows-{winArch}.{context.Version}");
            ...
            case PlatformFamily.Linux:
                ...
                await context.GitHubActions().Commands.UploadArtifact(new DirectoryPath($"Artifacts/native/mgfx-spvc/linux/{arch}/Release/"), $"mgfx-spvc-linux-{arch}.{context.Version}");
            ...
            case PlatformFamily.OSX:
                ...
                await context.GitHubActions().Commands.UploadArtifact(new DirectoryPath("Artifacts/native/mgfx-spvc/macosx/Release/"), $"mgfx-spvc-macos.{context.Version}");
